...
def create_debate_crew(topic: str):
    ...
    # The con_debate_task uses context from pro_debate_task, 
    # so its description does not need explicit topic injection here.

    debate_crew = Crew(
        agents=[ava_agent, ben_agent],
        tasks=[pro_debate_task, con_debate_task],
        process=Process.sequential,  # Ava speaks, then Ben responds
